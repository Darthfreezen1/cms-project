        ...
        <div>
            <ul>
                <li>Elemental Effectiveness: 
                    <ul class="element">
                        <li class="fire">Fire: <?=$row['fire']?></li>
                        <li class="water">Water: <?=$row['water']?></li>
                        <li class="wind">Wind: <?=$row['wind']?></li>
                        <li class="earth">Earth: <?=$row['earth']?></li>
                        <li class="mirage">Mirage: <?=$row['mirage']?></li>
                        <li class="soul">Soul: <?=$row['soul']?></li>
                        <li class="space">Space: <?=$row['space']?></li>
                    </ul>
                </li>
                <li><p><?=html_entity_decode($row['description'])?></p></li>
            </ul>
